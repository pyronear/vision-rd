"""Core data types for the mtb-change-detection pipeline.
...
class Detection:
    ...
    Attributes:
        ...
        change_ratio: Fraction of changed pixels in the bbox region between
            consecutive frames, or ``None`` if not computed (e.g. first frame).
    """
